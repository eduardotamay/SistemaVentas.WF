...
namespace Sistema.Presentacion
{
    public partial class FrmVenta : Form
    {
        ...
        private void CrearTabla()
        {
            ...
            DgvListado.Columns[7].ReadOnly = true;
        }
        ...
        {
            FrmVentaCliente frm = new FrmVentaCliente();
            frm.ShowDialog();
            TxtIdCliente.Text = Convert.ToString(Variables.IdCliente);
            TxtNombreCliente.Text = Variables.NombreCiente;
        }
        ...
        private void DgvDetalle_CellEndEdit(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                Cantidad = Stock;
                MensajeError("La cantidad de venta del articulo " + Cantidad + " supera el numero de stock " + Stock );
            }
